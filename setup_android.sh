...
BUILD_DIR="/mnt/android/lineage/prebuilts"

# Path to executables in Clang toolchain
clang_bin="$BUILD_DIR/clang/linux-x86/clang-r383902/bin"

# 64-bit GCC toolchain prefix
gcc_prefix64="$BUILD_DIR/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-"

# 32-bit GCC toolchain prefix
gcc_prefix32="$BUILD_DIR/gcc/linux-x86/arm/arm-linux-androideabi-4.9/bin/arm-linux-androideabi-"
